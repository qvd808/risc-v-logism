...
module soc_system_mm_interconnect_0 (
	...
	wire   [29:0] onchip_memory2_1_s1_agent_m0_address;                    // onchip_memory2_1_s1_agent:m0_address -> onchip_memory2_1_s1_translator:uav_address
	...
	wire  [123:0] onchip_memory2_1_s1_agent_rf_source_data;                // onchip_memory2_1_s1_agent:rf_source_data -> onchip_memory2_1_s1_agent_rsp_fifo:in_data
	...
	wire  [123:0] onchip_memory2_1_s1_agent_rsp_fifo_out_data;             // onchip_memory2_1_s1_agent_rsp_fifo:out_data -> onchip_memory2_1_s1_agent:rf_sink_data
	...
	wire  [122:0] onchip_memory2_1_s1_agent_rp_data;                       // onchip_memory2_1_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [158:0] router_src_data;                                         // router:src_data -> hps_0_h2f_axi_master_wr_limiter:cmd_sink_data
	...
	wire  [158:0] hps_0_h2f_axi_master_wr_limiter_cmd_src_data;            // hps_0_h2f_axi_master_wr_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [158:0] rsp_mux_src_data;                                        // rsp_mux:src_data -> hps_0_h2f_axi_master_wr_limiter:rsp_sink_data
	...
	wire  [158:0] hps_0_h2f_axi_master_wr_limiter_rsp_src_data;            // hps_0_h2f_axi_master_wr_limiter:rsp_src_data -> hps_0_h2f_axi_master_agent:write_rp_data
	...
	wire  [158:0] router_001_src_data;                                     // router_001:src_data -> hps_0_h2f_axi_master_rd_limiter:cmd_sink_data
	...
	wire  [158:0] hps_0_h2f_axi_master_rd_limiter_cmd_src_data;            // hps_0_h2f_axi_master_rd_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [158:0] rsp_mux_001_src_data;                                    // rsp_mux_001:src_data -> hps_0_h2f_axi_master_rd_limiter:rsp_sink_data
	...
	wire  [158:0] hps_0_h2f_axi_master_rd_limiter_rsp_src_data;            // hps_0_h2f_axi_master_rd_limiter:rsp_src_data -> hps_0_h2f_axi_master_agent:read_rp_data
	...
	wire  [122:0] onchip_memory2_1_s1_burst_adapter_source0_data;          // onchip_memory2_1_s1_burst_adapter:source0_data -> onchip_memory2_1_s1_agent:cp_data
	...
	wire    [1:0] onchip_memory2_1_s1_burst_adapter_source0_channel;       // onchip_memory2_1_s1_burst_adapter:source0_channel -> onchip_memory2_1_s1_agent:cp_channel
	...
	wire          router_003_src_valid;                                    // router_003:src_valid -> onchip_memory2_1_s1_rsp_width_adapter:in_valid
	wire  [122:0] router_003_src_data;                                     // router_003:src_data -> onchip_memory2_1_s1_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                    // onchip_memory2_1_s1_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [1:0] router_003_src_channel;                                  // router_003:src_channel -> onchip_memory2_1_s1_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                            // router_003:src_startofpacket -> onchip_memory2_1_s1_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                              // router_003:src_endofpacket -> onchip_memory2_1_s1_rsp_width_adapter:in_endofpacket
	wire          onchip_memory2_1_s1_rsp_width_adapter_src_valid;         // onchip_memory2_1_s1_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [158:0] onchip_memory2_1_s1_rsp_width_adapter_src_data;          // onchip_memory2_1_s1_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire          onchip_memory2_1_s1_rsp_width_adapter_src_ready;         // rsp_demux_001:sink_ready -> onchip_memory2_1_s1_rsp_width_adapter:out_ready
	wire    [1:0] onchip_memory2_1_s1_rsp_width_adapter_src_channel;       // onchip_memory2_1_s1_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire          onchip_memory2_1_s1_rsp_width_adapter_src_startofpacket; // onchip_memory2_1_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire          onchip_memory2_1_s1_rsp_width_adapter_src_endofpacket;   // onchip_memory2_1_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	...
	wire          cmd_mux_001_src_valid;                                   // cmd_mux_001:src_valid -> onchip_memory2_1_s1_cmd_width_adapter:in_valid
	wire  [158:0] cmd_mux_001_src_data;                                    // cmd_mux_001:src_data -> onchip_memory2_1_s1_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                   // onchip_memory2_1_s1_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                 // cmd_mux_001:src_channel -> onchip_memory2_1_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_001_src_startofpacket;                           // cmd_mux_001:src_startofpacket -> onchip_memory2_1_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_001_src_endofpacket;                             // cmd_mux_001:src_endofpacket -> onchip_memory2_1_s1_cmd_width_adapter:in_endofpacket
	...
	wire  [122:0] onchip_memory2_1_s1_cmd_width_adapter_src_data;          // onchip_memory2_1_s1_cmd_width_adapter:out_data -> onchip_memory2_1_s1_burst_adapter:sink0_data
	...
	wire    [1:0] onchip_memory2_1_s1_cmd_width_adapter_src_channel;       // onchip_memory2_1_s1_cmd_width_adapter:out_channel -> onchip_memory2_1_s1_burst_adapter:sink0_channel
	...
	altera_merlin_axi_master_ni #(
		...
		.aresetn                (~onchip_memory2_0_reset1_reset_bridge_in_reset_reset),  //        clk_reset.reset_n
