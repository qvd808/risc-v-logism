...
int main(int argc, char **argv) {
  ...
  tb.dut->eval();
  tb.tick(CLK_PERIOD);
  tb.check_bin("ADD ", tb.dut->ALUCU_OUT, 0b0010);
  ...
  tb.dut->eval();
  tb.tick(CLK_PERIOD);
  tb.check_bin("SUB ", tb.dut->ALUCU_OUT, 0b0110);
  ...
  tb.dut->eval();
  tb.tick(CLK_PERIOD);
  tb.check_bin("XOR ", tb.dut->ALUCU_OUT, 0b0011);
  ...
  tb.dut->eval();
  tb.tick(CLK_PERIOD);
  tb.check_bin("OR ", tb.dut->ALUCU_OUT, 0b0001);
  ...
  tb.dut->eval();
  tb.tick(CLK_PERIOD);
  tb.check_bin("AND ", tb.dut->ALUCU_OUT, 0b0000);
